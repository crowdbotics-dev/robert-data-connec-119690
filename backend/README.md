...
## Project Structure
    ...
    ├── robert_data_connec_119690  # Django project configurations
...
1. Clone this repo and `cd robert_data_connec_119690`
...
2. Clone this repo and `cd robert_data_connec_119690`
